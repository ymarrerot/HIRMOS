...
For the complete CLI guide, including version checks, updates, `--integration`, `--source`, `--version`, and `--offline`, see [`docs/reference/cli-reference.md`](./docs/reference/cli-reference.md).
...
1. [_hirmos/docs/1-use-hirmos/getting-started/README.md](./docs/1-use-hirmos/getting-started/README.md)
2. [_hirmos/docs/1-use-hirmos/getting-started/quickstart.md](./docs/1-use-hirmos/getting-started/quickstart.md)
3. [_hirmos/docs/1-use-hirmos/getting-started/first-real-run.md](./docs/1-use-hirmos/getting-started/first-real-run.md)

### I want to understand the methodology

Read:

- [_hirmos/docs/2-methodology/README.md](./docs/2-methodology/README.md)
- [_hirmos/docs/2-methodology/current-state-first.md](./docs/2-methodology/current-state-first.md)
- [_hirmos/docs/2-methodology/unresolved-items.md](./docs/2-methodology/unresolved-items.md)
- [_hirmos/docs/2-methodology/evidence-backed-review.md](./docs/2-methodology/evidence-backed-review.md)

### I want to inspect a HIRMOS run

Use the reference docs:

- [_hirmos/docs/reference/artifact-model.md](./docs/reference/artifact-model.md)
- [_hirmos/docs/reference/runtime-surfaces.md](./docs/reference/runtime-surfaces.md)
- [_hirmos/docs/reference/glossary.md](./docs/reference/glossary.md)

### I want to extend or contribute to HIRMOS

Start with:

- [_hirmos/docs/3-extend-contribute/README.md](./docs/3-extend-contribute/README.md)
...
- [_hirmos/docs/README.md](./docs/README.md) — docs entrypoint
- [_hirmos/docs/1-use-hirmos/](./docs/1-use-hirmos/) — how to use HIRMOS for software work
- [_hirmos/docs/2-methodology/](./docs/2-methodology/) — current-state-first methodology
- [_hirmos/docs/3-extend-contribute/](./docs/3-extend-contribute/) — how to extend or contribute
- [_hirmos/docs/reference/](./docs/reference/) — artifact, runtime, and glossary reference
