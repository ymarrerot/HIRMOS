...
## Bootstrap Quiz Answers

Answer the bootstrap quiz from `_hirmos/core/bootstrap.md`. Include enough detail to prove comprehension of the required authority/protocol files.
