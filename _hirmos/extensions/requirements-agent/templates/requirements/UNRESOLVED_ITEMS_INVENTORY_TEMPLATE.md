...
This artifact follows the unresolved-item contract and requirements spec. Populate it from producer `Unresolved Items` sections before feed reconciliation.
