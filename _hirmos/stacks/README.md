...
`_hirmos/stacks/` stores installed stack packages. Each stack package lives under `_hirmos/stacks/<stack-id>/` and is selected through `_hirmos/STACK_CONFIG.json`.