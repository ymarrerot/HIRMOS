...
- use the repository's existing test framework; add meaningful unit tests for material isolated deterministic logic when practical and preserve valid existing behavioral tests instead of weakening them to obtain PASS;
