...
| Baseline version | `0` |
| Coverage posture | `No accepted product requirements yet` |
| Incomplete / deferred requirements | `None recorded` |
...
Accepted cross-run lessons must preserve source traceability and must not replace the requirements baseline, decision log, or evidence artifacts.
