# Folder Rules — Extend & Contribute / Extensions

This file applies inside `_hirmos/docs/3-extend-contribute/extensions/` after the Phase 3B documentation information-architecture restructure.

# Folder Rules

## Purpose

Define what `/_hirmos/docs/3-extend-contribute/extensions/` is for, what it owns, what it must not own, and which nearby folders it is commonly confused with.
