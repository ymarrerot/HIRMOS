...
Use the practical guide to [Beyond Clear Specs methodology](../../2-methodology/beyond-clear-specs.md) and [extension application guide](beyond-clear-specs.md) whenever a runnable entrypoint should pair clear specs with self-validation, and especially when the run also needs stronger synthesis or surfaced-output governance.
