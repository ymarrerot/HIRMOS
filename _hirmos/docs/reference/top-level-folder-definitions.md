...
- `_hirmos/integrations/` — HIRMOS-owned integration surfaces; `integrations/agent-tools/` contains agent/IDE/tool bootstrap templates
- `_hirmos/tools/` — HIRMOS-maintained developer tooling; `tools/cli/` contains the TypeScript `hirmos init` CLI
...
- `_hirmos/project.json` — project-local HIRMOS configuration metadata
