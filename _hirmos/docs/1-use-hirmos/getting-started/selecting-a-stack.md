...
1. open `_hirmos/project.json`
2. change `stack.active_stack` to the desired stack id inside `_hirmos/project.json`
...
- [Core stacks](../../3-extend-contribute/core/stacks.md) if you want the deeper stack-package and stack-resolution mechanics.
