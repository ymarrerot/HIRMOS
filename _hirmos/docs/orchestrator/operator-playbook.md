...
If you are new to the broader framework model, it helps to review the [Conceptual diagram](../framework/conceptual-diagram.md) and the [Workflow diagram](../framework/workflow-diagram.md) first.
...
- **Go back to framework guidance:** return to [Framework guidance](../framework/README.md).
