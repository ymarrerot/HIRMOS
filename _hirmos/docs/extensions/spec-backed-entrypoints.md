...
Also consider the [Beyond Clear Instructions](./beyond-clear-instructions.md) when the entrypoint should pair clear instructions with self-validation, especially if the run also produces a critical surfaced result.
