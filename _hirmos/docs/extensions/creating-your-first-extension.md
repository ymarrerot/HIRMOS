...
Even for a first extension, use the [Beyond Clear Instructions](./beyond-clear-instructions.md) when the runnable surface can self-check whether its clear instructions were followed. As the extension becomes more serious, use the fuller pattern when synthesis or surfaced-output governance also matters.
