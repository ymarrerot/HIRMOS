...
This public repository is for the open Core, framework docs, starter templates, and bundled example extensions. Marketplace extensions and private owner tooling are not accepted into the public Core repository.

## Pull requests

Small docs fixes can go straight to a PR. For anything larger, open an issue first.

Before opening a PR, run the relevant checks. At minimum, public Core changes should pass:
